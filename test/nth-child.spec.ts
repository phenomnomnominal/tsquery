    ...
    describe('tsquery - nth-child:', () => {
        it('should find any nodes that are the first-child of a list of nodes', () => {
            ...
            expect(result).to.deep.equal([
                ...
                ((ast.statements[0] as IfStatement).elseStatement as Block).statements[0],
                ((ast.statements[1] as IfStatement).thenStatement as Block).statements[0],
                (((ast.statements[1] as IfStatement).elseStatement as IfStatement).thenStatement as Block).statements[0]
            ]);
        });
